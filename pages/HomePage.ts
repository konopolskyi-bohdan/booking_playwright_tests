...
export class HomePage {
    ...
    async selectDates(checkIn: string, checkOut: string) {
        ...
        await this.getDateCell(checkIn).click()

        await this.checkOutField.click()
        await this.getDateCell(checkOut).click()
    }
